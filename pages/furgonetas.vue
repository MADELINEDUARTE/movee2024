<template>
    <LayoutWeb>
         <div class="site-breadcrumb" style="background: url(/assets/img/furgonetas/01.png)">
            <div class="container">
                <h2 class="breadcrumb-title">{{$t('renting_co')}} <br> <span>{{$t('furgonetas')}}</span> </h2>
                    <br>
                    <br>
                    <div>
        ...
        <div class="about-area">
            ...
            <div class="about-right">
                <div class="site-heading mb-3">
                    ...
                    <h2 class="site-title">
                        {{$t('c_suv')}} <span>{{$t('nuevo_furgo')}}</span> {{$t('p_particular')}}
                    </h2>
                </div>
                <p> {{$t('t_furgo')}}
                </p>
