<template>
    <LayoutWeb>
         <div class="site-breadcrumb" style="background: url(/assets/img/hibridos/01.png)">
            <div class="container">
                <h2 class="breadcrumb-title">{{$t('renting_co')}} <br> <span>{{$t('h_elect')}}</span> </h2>
                    <br>
                    <br>
                    <div>
        ...
        <div class="about-area">
            ...
            <div class="about-right">
                <div class="site-heading mb-3">
                    ...
                    <h2 class="site-title">
                        {{$t('ofer_elec')}} <span>{{$t('c_hibridos_elec')}}</span> {{$t('adaptados')}}
                    </h2>
                </div>
                <p> {{$t('t_hibridos')}}
                </p>
