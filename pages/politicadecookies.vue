            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="terms-content">
                            ...
                            procesamiento de su información personal, incluso con respecto a las cookies (por ejemplo, un derecho de acceso, rectificación o suspensión). Puede aceptar o rechazar fácilmente su uso eligiendo las opciones adecuadas en el centro de privacidad. Asimismo, puede retirar su consentimiento y solicitar la eliminación de esta información en cualquier momento.</p>
                            <p>Puede obtener más información sobre estos derechos en el apartado de la política de privacidad de 123renting dedicado a los derechos de protección de datos o puede ejercer sus derechos a través del formulario en línea disponible aquí.</p>
                            <p>También puede gestionar la configuración de cookies en su navegador web. Para obtener más información sobre cómo gestionar sus cookies a través de su navegador, consulte la sección de «Ayuda» del navegador específico o haga clic en el enlace correspondiente: Google Chrome, Microsoft Internet Explorer, Mozilla Firefox, Apple Safari.</p>
                    </div>

                    <div class="terms-content">
                            <h3>F. ¿A quién debe contactar cuando tenga una duda sobre el uso de sus cookies?</h3>
                            <p>Si tiene alguna consulta sobre el uso que 123renting hace de las cookies, contacte con: 
                            <a href="#">info@123rentring.es.</a></p>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <p class="copyright-text">
                        &copy; Copyright <span id="date"></span> <a href="#"> <strong>123 RENTING</strong></a> Todos los derechos reservados 2023.
                    </p>
                </div>
                <div class="col-md-6 align-self-center">
