...
<LayoutWeb>
    <!-- breadcrumb -->
        <div class="site-breadcrumb" style="background: url(assets/img/empresas/01.png)">
            <div class="container">
                <h2 class="breadcrumb-title">{{$t('ofertas_ren')}} <br> <span>{{$t('p_empresas')}}</span> </h2>
                    <br>
                    <br>
                    <div>
        ...
        <div class="about-area">
            ...
            <div class="about-right">
                <div class="site-heading mb-3">
                    ...
                    <h2 class="site-title">
                        {{$t('ofertas_destacadas')}} <span>{{$t('p_empresas')}} </span>
                    </h2>
                </div>
                <p>{{$t('texto_empresas')}}</p>
            </div>
        </div>
            </div>
        </div>
        ...
        <div class="col-lg-6 col-xl-4">
            <div class="car-item">   
                ...
                <div class="car-content">
                    <div class="car-top">
                        <div>
                            <h4 class="textflex">{{$t('ren_empresas')}}</h4>
                        </div>
                    </div>
                     <div class="car-top">
